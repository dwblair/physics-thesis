...
\begin{figure}[h]
\label{fig:N9}
\scalebox{.5}{\includegraphics{3x3.eps}}
...
\begin{figure}[H]
\scalebox{.4}{\includegraphics{bravais1.eps}}
...
\begin{figure}[H]
\scalebox{.4}{\includegraphics{alignedBlocks3.eps}}
...
\begin{figure}[H]
\scalebox{.48}{\includegraphics{n7a.eps}}
...
\begin{figure}[H]
\scalebox{.48}{\includegraphics{gappedCombo1.eps}}
...
\begin{figure}[H]
\scalebox{.7}{\includegraphics{n22Edit.eps}}
...
\begin{figure}[H]
\scalebox{.5}{\includegraphics{N21.eps}}
...
\bibinfo{author}{\bibfnamefont{T.}~\bibnamefont{Ras}},
  ...
  \bibnamefont{and} \bibinfo{author}{\bibfnamefont{M.}~\bibnamefont{Weigel}},
   \bibinfo{journal}{Physical Review Letters} \textbf{\bibinfo{volume}{107}}, \bibinfo{pages}{215503}
  (\bibinfo{year}{2011}).
